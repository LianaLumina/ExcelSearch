...
| Search (light) | Settings (dark) |
|---|---|
| ![Search page](docs/images/search-light.png) | ![Settings page](docs/images/settings-dark.png) |

| Manual window (light) | Manual window (dark) |
|---|---|
| ![Manual window](docs/images/manual-light.png) | ![Manual window, dark](docs/images/manual-dark.png) |

> Screenshots are generated by the built-in offscreen capture hook (`--shot`) and match the running UI.
